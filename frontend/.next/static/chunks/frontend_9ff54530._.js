...
async function getFHEVMRelayerMetadata(rpcUrl) {
    ...
    try {
        ...
        const errorMessage = String((e === null || e === void 0 ? void 0 : e.message) || "");
        if (errorMessage.includes("Failed to fetch") || errorMessage.includes("ECONNREFUSED")) {
            // Non-critical - node might not be running
            throw new FhevmReactError("FHEVM_RELAYER_METADATA_ERROR", "Cannot connect to ".concat(rpcUrl, ". Make sure Hardhat node is running."));
        }
            ...
            if (_isRunning === true) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$fhevm$2f$internal$2f$fhevm$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createFhevmInstance"])({
                    ...
                    "useFhevm.useEffect": (e)=>{
                        ...
                        const errorMessage = (e === null || e === void 0 ? void 0 : e.message) || (e === null || e === void 0 ? void 0 : e.toString()) || "";
                        const isNonCriticalError = errorMessage.includes("Failed to fetch") || errorMessage.includes("NetworkError") || errorMessage.includes("Load failed");
...
"[project]/frontend/abi/EnergyLogStorageAddresses.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
*/ __turbopack_context__.s([
    "EnergyLogStorageAddresses",
    ()=>EnergyLogStorageAddresses
]);
const EnergyLogStorageAddresses = {
    "11155111": {
        address: "0xaDa7b9535b9347490Bb09b70fE439f771F9a3b11",
        chainId: 11155111,
        chainName: "sepolia"
    },
    "31337": {
...
"[project]/frontend/abi/EnergyLogStorageABI.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/frontend/components/EnergyLogDemo.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$EnergyLogStorageAddresses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/abi/EnergyLogStorageAddresses.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$EnergyLogStorageABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/abi/EnergyLogStorageABI.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const EnergyLogDemo = ()=>{
    ...
    const [decryptingIndex, setDecryptingIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // Get contract info
    const contractInfo = chainId ? __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$EnergyLogStorageAddresses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EnergyLogStorageAddresses"][chainId.toString()] : undefined;
    const contractAddress = contractInfo === null || contractInfo === void 0 ? void 0 : contractInfo.address;
    ...
    const fhevmProvider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EnergyLogDemo.useMemo[fhevmProvider]": ()=>{
            if (walletClient) {
    ...
    const provider = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EnergyLogDemo.useMemo[provider]": ()=>{
            if (walletClient) {
            ...
            if (chainId === 31337) {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].JsonRpcProvider("http://localhost:8545");
            }
            return undefined;
        }
    }["EnergyLogDemo.useMemo[provider]"], [
    ...
    // Load logs
    const loadLogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "EnergyLogDemo.useCallback[loadLogs]": async ()=>{
            if (!isConnected || !address || !contractAddress || !walletClient) return;
            try {
                const signer = await new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(walletClient).getSigner();
                const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(contractAddress, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$EnergyLogStorageABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EnergyLogStorageABI"].abi, signer);
                ...
                for(let i = 0; i < count; i++){
                    try {
                        ...
                        console.error("Failed to get log ".concat(i, ":"), e);
                    }
                }
                setLogs(newLogs);
            } catch (e) {
                ...
                const errorMessage = (e === null || e === void 0 ? void 0 : e.message) || (e === null || e === void 0 ? void 0 : e.toString()) || "";
                const isNonCriticalError = errorMessage.includes("Failed to fetch") || errorMessage.includes("could not decode result data") || errorMessage.includes("NetworkError");
                if (!isNonCriticalError) {
                    console.error("Failed to load logs:", e);
                    setMessage("Failed to load logs: ".concat(e.message));
                } else {
    ...
    }["EnergyLogDemo.useCallback[loadLogs]"], [
        isConnected,
        address,
        contractAddress,
        walletClient
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const encryptedInput = fhevmInstance.createEncryptedInput(contractAddress, userAddress).add64(electricity).add64(gas).add64(water);
            let encrypted;
            try {
                ...
                if (errorMessage.includes("Relayer") || errorMessage.includes("Bad JSON") || errorMessage.includes("relayer")) {
                    setMessage("FHEVM Relayer service error. This may be due to: (1) Network connectivity issues, (2) Relayer service temporarily unavailable, (3) Please try again in a few moments. If the problem persists, check your network connection or try switching networks.");
                    return;
                }
                throw encryptError;
            }
            ...
            const tx = await contract.addEnergyLog(form.date, encrypted.handles[0], encrypted.handles[1], encrypted.handles[2], encrypted.inputProof);
            ...
            if (errorMessage.includes("Relayer") || errorMessage.includes("Bad JSON") || errorMessage.includes("relayer")) {
                setMessage("FHEVM Relayer service error. Please: (1) Check your internet connection, (2) Wait a moment and try again, (3) Ensure you're on the correct network (Sepolia or Hardhat Local)");
                ...
                setMessage("Failed: ".concat(errorMessage));
            }
        } finally{
            setLoading(false);
        }
    ...
    const decryptLog = async (index)=>{
        ...
        try {
            const signer = await new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(walletClient).getSigner();
            const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(walletClient);
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(contractAddress, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$abi$2f$EnergyLogStorageABI$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EnergyLogStorageABI"].abi, provider);
            ...
            const zero = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].ZeroHash;
            const handles = [
                {
                    handle: electricityHandle,
                    contractAddress
                },
                {
                    handle: gasHandle,
            ...
            const sig = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$fhevm$2f$FhevmDecryptionSignature$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FhevmDecryptionSignature"].loadOrSign(fhevmInstance, [
                contractAddress
            ], signer, fhevmDecryptionSignatureStorage);
            if (!sig) {
                setMessage("Failed to create decryption signature");
                return;
            }
            // Decrypt
            const results = await fhevmInstance.userDecrypt(handles.map({
                "EnergyLogDemo.decryptLog.userDecrypt": (h)=>({
                        handle: h.handle,
                        contractAddress: h.contractAddress
                    })
            }["EnergyLogDemo.decryptLog.userDecrypt"]), sig.privateKey, sig.publicKey, sig.signature, sig.contractAddresses, sig.userAddress, sig.startTimestamp.toString(), sig.durationDays.toString());
            // Update log with decrypted values
            setLogs((prev)=>prev.map((log)=>{
                    var _results_electricityHandle, _results_gasHandle, _results_waterHandle;
                    return log.index === index ? {
                        ...log,
                        electricity: ((_results_electricityHandle = results[electricityHandle]) === null || _results_electricityHandle === void 0 ? void 0 : _results_electricityHandle.toString()) || undefined,
                        gas: ((_results_gasHandle = results[gasHandle]) === null || _results_gasHandle === void 0 ? void 0 : _results_gasHandle.toString()) || undefined,
                        water: ((_results_waterHandle = results[waterHandle]) === null || _results_waterHandle === void 0 ? void 0 : _results_waterHandle.toString()) || undefined,
                        encrypted: false
                    } : log;
                }));
            ...
            if (!errorMessage.includes("Failed to fetch") && !errorMessage.includes("NetworkError")) {
                ...
                setMessage("Failed to decrypt: ".concat(errorMessage));
            } else {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                        lineNumber: 355,
                        columnNumber: 11
                    }, ("TURBOPACK compile-time value", void 0)),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-gray-600 mb-6 text-center",
                        children: "Connect your Rainbow wallet to start managing your encrypted energy logs"
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                        lineNumber: 358,
                        columnNumber: 11
    ...
    const switchToLocalhost = async ()=>{
        ...
        try {
            ...
            if ((error === null || error === void 0 ? void 0 : error.code) === 4902 || (error === null || error === void 0 ? void 0 : (_error_message = error.message) === null || _error_message === void 0 ? void 0 : _error_message.includes("not added")) || (error === null || error === void 0 ? void 0 : (_error_message1 = error.message) === null || _error_message1 === void 0 ? void 0 : _error_message1.includes("Unrecognized chain"))) {
                try {
                    // Use wallet's request method to add chain
                    const provider = new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].BrowserProvider(walletClient);
                    const signer = await provider.getSigner();
                    const providerEip1193 = signer.provider;
                ...
                setMessage("Failed to switch network: ".concat((error === null || error === void 0 ? void 0 : error.message) || "Unknown error"));
            }
        }
    };
    if (!isDeployed) {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-white rounded-xl p-8 shadow-lg border-2 border-red-200",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                    ...
                    isSepolia ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600 mb-4",
                                children: [
                                    "EnergyLogStorage contract is not deployed on Sepolia (chain ",
                                    chainId,
                                    ")."
                                ]
                            }, void 0, true, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-800 font-semibold mb-4 text-lg",
                                children: "⚠️ Please switch to Hardhat Local network (Chain ID: 31337)."
                            }, void 0, false, {
                                fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                lineNumber: 436,
                                columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: "🔄 Switch to Hardhat Local Network"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                    lineNumber: 442,
                                    columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Or add network manually:"
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                        lineNumber: 451,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: "Click on the network selector in your wallet (top right)"
                                            }, void 0, false, {
                                                fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                                lineNumber: 453,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "ml-6",
                                                children: "- Network Name: Hardhat Local"
                                            }, void 0, false, {
                                                fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                                lineNumber: 455,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "ml-6",
                                                children: "- RPC URL: http://localhost:8545"
                                            }, void 0, false, {
                                                fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                                lineNumber: 456,
                                                columnNumber: 19
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: [
                                    "Or deploy the contract to Sepolia: ",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("code", {
                                        ...
                                        children: "npx hardhat deploy --network sepolia"
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                        lineNumber: 462,
                                        columnNumber: 52
                    ...
                    }, void 0, true) : isLocalhost ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600 mb-2",
                                children: [
                                    "EnergyLogStorage contract is not deployed on Hardhat Local (chain ",
                                    chainId,
                                    ")."
                                ]
                            }, void 0, true, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600 mb-2",
                                children: "Please deploy it first:"
                            }, void 0, false, {
                                fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                lineNumber: 470,
                                columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-gray-100 rounded p-3 mb-2",
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600 mb-4",
                                children: [
                                    "EnergyLogStorage contract is not deployed on chain ",
                                    chainId,
                                    "."
                                ]
                            }, void 0, true, {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex justify-between items-center bg-white rounded-xl p-4 shadow-lg border-2 border-purple-200",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isConnected && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    " ",
                                    chainId === 31337 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        lineNumber: 508,
                                        columnNumber: 17
                                    }, ("TURBOPACK compile-time value", void 0)) : chainId === 11155111 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            isConnected && chainId !== 31337 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: switchToLocalhost,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: loading ? "Adding..." : fhevmStatus !== "ready" ? "Initializing encryption..." : "Add Energy Log"
                            }, void 0, false, {
                                fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                lineNumber: 591,
                                columnNumber: 11
            ...
            message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "p-4 rounded-lg ".concat(message.includes("Failed") || message.includes("Error") ? "bg-red-100 text-red-700 border border-red-300" : "bg-green-100 text-green-700 border border-green-300"),
                children: message
            }, void 0, false, {
                fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                lineNumber: 607,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: [
                        ...
                        fhevmError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    logs.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-gray-500 text-center py-8",
                        children: "No logs yet. Add your first energy log above!"
                    }, void 0, false, {
                        fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                        lineNumber: 634,
                        columnNumber: 11
                        ...
                        className: "space-y-4",
                        children: logs.map((log)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "font-semibold",
                                                                    children: log.electricity ? "".concat(log.electricity, " kWh") : "***"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                                                    lineNumber: 650,
                                                                    columnNumber: 25
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "font-semibold",
                                                                    children: log.gas ? "".concat(log.gas) : "***"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                                                    lineNumber: 656,
                                                                    columnNumber: 25
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "font-semibold",
                                                                    children: log.water ? "".concat(log.water, " L") : "***"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                                                    lineNumber: 662,
                                                                    columnNumber: 25
                                        ...
                                        log.encrypted && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            children: decryptingIndex === log.index ? "Decrypting..." : "Decrypt"
                                        }, void 0, false, {
                                            fileName: "[project]/frontend/components/EnergyLogDemo.tsx",
                                            lineNumber: 669,
                                            columnNumber: 21
...
_s(EnergyLogDemo, "yPxY/gfd/92oZNcGqOUtCbvZZp8=", false, function() {
    return [
...
_c = EnergyLogDemo;
var _c;
__turbopack_context__.k.register(_c, "EnergyLogDemo");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=frontend_9ff54530._.js.map